...
| 提交本地任务 | 提交本地已准备好的 ep01 task03 生成视频。 |
| 查询本地任务 | 查一下 ep01 的 task03 生成到哪了。 |
| 下载本地任务 | 下载 ep01 的 task03 已完成的视频。 |
| 持续监控 | 持续监控 ep01 已登记的视频任务，完成后下载。 |
| 停止监控 | 停止 ep01 的持续监控。 |

修改、恢复、视频提交、查询、下载和监控均用自然语言委托，AI 按实际目标与授权加载所需内部能力。单集与系列制作也同样支持自然语言。
