...
4. **表演与观众体验**：重要互动有具体话语、行动与回应；人物目标、策略变化、利害关系与情感触发可感知。词汇、句法、称呼和比喻有生活及关系依据，不仅音色有区别。信息通过当前互动进入，主题有选择及后果支撑。内心声、自语、旁白、画外对话或字幕按作用使用，明确谁能听见；VO 可提供视角、自我辩解或反差，不默认复述情绪，也不设数量或不可替代门槛。
...
区分作者背景与观众实际得到的证据。年份、方位与装置前情可留背景；本场必须传达的事实应有既有设计支持的可见或可听表达。核对人物和道具的当前状态、注意力变化及其动作依据，保持已有站位与持有关系。
...
对同质台词、说明书式对话或主题宣讲的意见，定位具体交锋及其失败效果：没有接住对方回应、双方无当前动机却互述已知资料，或观众未获必要证据就被要求理解转折。按实际措辞和节奏试读/估读，说明判断依据，不虚称录音实测。直接表态、完整句、寒暄、风格化警句或有效内心声本身不是缺陷；不以俚语、停顿、形容词或术语出现次数判质量。
