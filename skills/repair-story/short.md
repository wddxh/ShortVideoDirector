...
- sheet image recovery：prompt review 通过后使用 Skill tool 调用 `creator-generate-images` skill，参数 `ep01 storyboard-sheets`；再使用 Skill tool 调用 `director-review-storyboard-sheets-visual` skill，参数 `ep01`。
