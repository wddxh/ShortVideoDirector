...
- 视点与镜头：按 [视点、镜头与连续性](camera-language.md) 选择主观 POV、过肩、外部观察或动作细节；不默认第三人称。用景别、角度、视线匹配和有动机的运动让关键动作可读。BOX 控制相机/位置/轨迹及必要最小支撑；完整操作、朝向、握持和关键过程写入 prose，最终 prompt 解释代理的解剖/动作实现。
