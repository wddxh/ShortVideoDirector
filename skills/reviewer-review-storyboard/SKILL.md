...
语义判断由当前独立 Reviewer 完成。先定位具体 shot/阶段的几何或故事冲突及影响，再列可选修法与取舍；侧面高角度、OTS、插入或 POV 都可成立。BOX 默认无需完整 rig、精细手指或脸部动画；持有、支撑或动作否则不可读/悬浮时，最小手/前臂、相关肢体或接触代理属于本地授权，不限身体出画。缺手指不判失败，缺必要支撑与动作冲突则需修正；悬浮与透明屏幕按意图判断。不以个人机位偏好、美学精度或通用 dot-product gate 验收。
